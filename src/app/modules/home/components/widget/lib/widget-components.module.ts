...
import { MultipleInputWidgetComponent } from './multiple-input-widget.component';
import { TripAnimationComponent } from '../trip-animation/trip-animation.component';
import { PhotoCameraInputWidgetComponent } from './photo-camera-input.component';
import { GatewayFormComponent } from './gateway/gateway-form.component';
...
import { MachineMonitorEntitiesTableComponent } from '@home/components/widget/lib/machine-monitor-entities-table.component';
import { SerialEntitiesTableComponent } from '@home/components/widget/lib/serial-entities-table.component';
...
@NgModule({
  declarations:
    [
      ...
      MachineMonitorEntitiesTableComponent,
      SerialEntitiesTableComponent
    ],
  imports: [
    CommonModule,
    SharedModule,
