...
@Component({
  selector: 'tb-serial-entities-table',
  templateUrl: './serial-entities-table.component.html',
  styleUrls: ['./serial-entities-table.component.scss','./table-widget.scss']
})
export class SerialEntitiesTableComponent extends PageComponent implements OnInit, AfterViewInit, OnDestroy{
  ...
  @Input()
    ...
    ngAfterViewInit(): void {
      ...
      // -------------------- Code Start -----------------
      var localCheckFilter = JSON.parse(sessionStorage.getItem("checkFillterSerial"));
      console.log("----------localCheckFilter------------", localCheckFilter);
      var localFillterArr = JSON.parse(sessionStorage.getItem("fillterArrSerial"));
      console.log("----------localFillterArr------------", localFillterArr);
      var giamsatPageIndex = JSON.parse(sessionStorage.getItem("serialPageIndex"));
      this.paginator.pageIndex = giamsatPageIndex;
      var giamsatPageSize = JSON.parse(sessionStorage.getItem("serialPageSize"));
    ...
    ngOnDestroy() {
      sessionStorage.setItem("serialPageIndex", JSON.stringify(this.paginator.pageIndex));
      sessionStorage.setItem("serialPageSize", JSON.stringify(this.paginator.pageSize));
    }
    ...
    handleSearchByColumn() {
      ...
      if (this.checkFillter == true) {
        ...
        sessionStorage.setItem("checkFillterSerial", JSON.stringify(this.checkFillter));
        sessionStorage.setItem("fillterArrSerial", JSON.stringify(this.fillterArr));
