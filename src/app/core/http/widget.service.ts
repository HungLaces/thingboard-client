...
export class WidgetService {
  ...
  public getReportData() {
    return this.http.get("http://"+window.location.hostname+":8045/reportApi/getDataReport");
  }

  public getListError() {
    return this.http.get("http://"+window.location.hostname+":8045/api/report/getListError");
  }

  public getListErrorHMI() {
    return this.http.get("http://"+window.location.hostname+":8045/api/report/getListErrorHMI");
  }

  public getListAllError() {
    return this.http.get("http://"+window.location.hostname+":8045/reportApi/getAllListError");
  }

  public getListErrInCommon() {
    return this.http.get("http://"+window.location.hostname+":8045/reportApi/getAllListErrInCommon");
  }

  public getListMachineForExcel(){
    return this.http.get("http://192.168.68.87:9089/api/scada_wo_info/listMachineForExcel");
  }
