    ...
    (Z.fn.dateRangePicker = function (p) {
      ...
      return (
        ...
        function () {
          ...
          Z(this).data("date-picker-opened", !0),
            (m = (function () {
              ...
              if (
                ...
                if (p.customShortcuts)
                  for (var i = 0; i < p.customShortcuts.length; i++) {
                    var d = p.customShortcuts[i];
                    t +=
              ...
              if (
                ...
                for (var i = 0; i < p.customValues.length; i++) {
                  var l = p.customValues[i];
                  t +=
            ...
            p.inline ? m.addClass("inline-wrapper") : i();
        ...
        Z(this).data("dateRangePicker", {
          ...
          destroy: function () {
            Z(n).off(".datepicker"),
              ...
              m.remove(),
              Z(window).off("resize.datepicker", i),
              Z(document).off("click.datepicker", U);
          },
        }),
        Z(window).on("resize.datepicker", i),
        this
      );
      function i() {
        if (!p.inline) {
      ...
      function u(e, t) {
        m.find("." + e + " input[type=range].hour-range").val(Q(t).hours()),
          m
            ...
            .val(Q(t).minutes()),
          f(e, Q(t).format("HH"), Q(t).format("mm"));
      }
      function h(e, t) {
        p[e] = parseInt(
          Q(parseInt(t))
      ...
      function k(e) {
        ...
        if (p.start && !p.end && !p.singleDate) {
          if (0 < p.maxDays && C(e, p.start) > p.maxDays) return !1;
          if (0 < p.minDays && C(e, p.start) < p.minDays) return !1;
      ...
      function D(e) {
        ...
        s &&
          ...
          o &&
            i.isSameOrAfter(o) &&
            (i = o.add(p.singleMonth || "month1" !== n ? 0 : -1, "month")),
          z(i, n),
          "month1" === n
            ? (p.stickyMonths || Q(i).isSameOrAfter(p[r], "month")) &&
              z(Q(i).add(1, "month"), r)
            : (p.stickyMonths || Q(i).isSameOrBefore(p[r], "month")) &&
              z(Q(i).add(-1, "month"), r),
          I();
      }
      function x() {
        ...
        m.find(".start-day").html("..."),
          ...
          p.start && p.singleDate
            ? (m.find(".apply-btn").removeClass("disabled"),
              ...
              p.setValue.call(o, a, W(new Date(p.start)), W(new Date(p.end))),
              s &&
                !t &&
      ...
      function z(e, t) {
        var a = (function (e, t) {
            ...
            if (
              ((e = Q(e)), !p.monthSelect || (n && r && n.isSame(r, "month")))
            )
              return (
                '<div class="month-element">' + A(e.get("month")) + "</div>"
              );
            if (
              (a = [
                n && e.isSame(n, "year") ? n.get("month") : 0,
                e ? e.get("month") : 11,
              ])[0] === a[1]
            )
              return (
          ...
          n = (function (e, t) {
            ...
            var a,
              ...
              s = e.get("year"),
              o = p.yearSelect && "function" == typeof p.yearSelect;
            if (!p.yearSelect || (n && r && n.isSame(Q(r), "year")))
              return '<div class="month-element">' + s + "</div>";
            return (
              (a = o ? p.yearSelect(s) : p.yearSelect.slice()),
              V(
                "year",
                P(
                  (a = [
                    n ? Math.max(a[0], n.get("year")) : Math.min(a[0], s),
                    r ? Math.min(a[1], r.get("year")) : Math.max(a[1], s),
                  ]),
                  s
                )
              )
            ...
            (function (e) {
              ...
              if (0 < s)
                for (var o = s; 0 < o; o--) {
                  ...
                  (n = k(i.getTime())),
                    p.startDate && F(i, p.startDate) < 0 && (n = !1),
                    p.endDate && 0 < F(i, p.endDate) && (n = !1),
                    t.push({
                      date: i,
                      type: "lastMonth",
                      day: i.getDate(),
              ...
              for (
                ...
                l.push("<tr>");
                for (var i = 0; i < 7; i++) {
                  var m = "monday" == p.startOfWeek ? i + 1 : i;
                  a = t[7 * u + m];
                  ...
                  if (
                    ...
                    var f = p.beforeShowDay(Q(a.time).toDate());
                    (a.valid = f[0]),
                      (a.extraClass = f[1] || ""),
                      (a.tooltip = f[2] || ""),
